...
from tp_dashboard.model_wrappers import AppointmentModelWrapper
...
class ActionItemModelWrapper(ModelWrapper):
    ...
    @property
    def ae_initial(self):
        if self.object.parent_reference_model == 'trainee_project_ae.aeinitial':
            mdl_cls = django_apps.get_model('trainee_project_ae', 'aeinitial')
            try:
                ...
                pass
        elif self.object.parent_reference_model == 'trainee_project_ae.aefollowup':
            mdl_cls = django_apps.get_model('trainee_project_ae', 'aefollowup')
            try:
